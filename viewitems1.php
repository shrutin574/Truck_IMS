	...
	<?php
		...
		// {
			...
			echo"</tr>";
						...
						echo"<tr>";
			echo"<th>";
			echo"Transport Name"; echo"<td>";echo $row["tname"]; echo"</td>";
			echo"</th>";
			echo"</tr>";
			...
			echo"</tr>";
						...
						echo"<tr>";
			echo"<th>";
			echo"INVOICE NO"; echo"<td>";echo $row["invoiceno"]; echo"</td>";
			echo"</th>";
			echo"</tr>";
            ...
            echo"<tr>";
			echo"<th>";
			echo"BELTS AVAILABLE"; echo"<td>";echo $row["beltsavail"]; echo"</td>";
			echo"</th>";
			echo"</tr>";
            
           	echo"<tr>";
			echo"<th>";
			echo"WEDGES AVAILABLE"; echo"<td>";echo $row["wedgesavail"]; echo"</td>";
			echo"</th>";
			echo"</tr>";
            ...
            echo"<tr>";
			echo"<th>";
			echo"BELTS SENT"; echo"<td>";echo $row["beltssent"]; echo"</td>";
			echo"</th>";
			echo"</tr>";
            
           	echo"<tr>";
			echo"<th>";
			echo"WEDGES SENT"; echo"<td>";echo $row["wedgessent"]; echo"</td>";
			echo"</th>";
			echo"</tr>";
	...
	<?php
		if(isset($_POST['search']))
		{
			...
			echo"</tr>";
			  	...
			  	echo"<tr>";
			echo"<th>";
			echo"Damage"; echo"<td>";echo $row["damage"]; echo"</td>";
			echo"</th>";
			echo"</tr>";
			...
			echo"</tr>";
						...
						echo"<tr>";
			echo"<th>";
			echo"TINVOICE NO"; echo"<td>";echo $row["invoiceno"]; echo"</td>";
			echo"</th>";
			echo"</tr>";
...
<center>
	<tr align="center">
		<td colspan="4">
			...
			<a href="excel.php"><button class="btn-sub"  name="submit">REPORTS</button></a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
